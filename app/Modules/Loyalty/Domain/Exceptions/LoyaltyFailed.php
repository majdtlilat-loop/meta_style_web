...
/**
 * A points operation the rules refuse — not enough points, no program, no
 * customer on the sale.
 */
final class LoyaltyFailed extends RuntimeException implements ApiProblem, HttpExceptionInterface
{
    /**
    ...
    {
        return new self($message, ApiErrorCode::LoyaltyInvalidTransition, $details);
    }
    ...
    {
        return new self($message, ApiErrorCode::LoyaltyPolicyViolation, $details);
    }
